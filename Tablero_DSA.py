...
app.layout = dbc.Container([
    ...
    html.Div([
        ...
        dbc.Row([
            crear_slider_section("Campaña", "camp", 0, 60, 1, 42, {0: "0", 20: "20", 40: "40", 60: "60"}),
            crear_slider_section("Días desde Último Contacto", "dias", 0, 800, 10, 400, 
                               {0: "0", 200: "200", 400: "400", 600: "600", 800: "800"}),
            crear_slider_section("Contactos Previos", "cont", 0, 270, 5, 180, 
        ...
        dbc.Row([
            ...
            dbc.Col([
                html.Div([
                    ...
                    html.H1("72%", className="text-center fw-bold mb-2", 
                            style={'color': COLORS['primary'], 'fontSize': '48px'}),
                    html.P("Probabilidad de Aceptación", 
                           className="text-center mb-0 text-muted", 
                           style={'fontSize': '14px', 'fontWeight': '500'}),
                    html.Div([
                        html.Span("▲ 8%", className="badge bg-success mt-2", style={'fontSize': '12px'})
    ...
    html.Div([
        ...
        html.Div([
            html.P("El perfil analizado presenta una probabilidad de adquisición del 72%, "
                   "indicando un alto potencial de conversión.", 
                   className="mb-3", style={'color': COLORS['text']}),
            html.P("Para optimizar el desempeño de la campaña, considere:", 
                   className="mb-2 fw-semibold", style={'color': COLORS['text']}),
            html.Ul([
                html.Li("Enfocarse en clientes dentro del rango de edad de 40-70 años", className="mb-2"),
                html.Li("Priorizar clientes con balance positivo mayor a $20,000", className="mb-2"),
                html.Li("Optimizar la duración de contacto entre 1,500-2,500 segundos", className="mb-2"),
                html.Li("Realizar seguimiento dentro de los primeros 300 días del último contacto"),
...
def update_dias(v): return f"{v} días"
...
def crear_callback_botones(grupo_id, opciones):
    ...
    def toggle_buttons(*args):
        if not ctx.triggered_id:
            return [True] * len(opciones) + ["primary"] * len(opciones)
...
crear_callback_botones("civil", ["married", "single", "divorced"])

crear_callback_botones("educacion", ["primary", "secondary", "tertiary", "unknown"])

crear_callback_botones("creditos", ["yes", "no"])

crear_callback_botones("hipotecario", ["yes", "no"])

crear_callback_botones("personal", ["yes", "no"])

crear_callback_botones("contacto", ["cellular", "telephone", "unknown"])

crear_callback_botones("resultado", ["success", "failure", "other", "unknown"])

crear_callback_botones("mes", [
    "jan", "feb", "mar", "apr", "may", "jun", 
    "jul", "aug", "sep", "oct", "nov", "dec"
])
