...
NAME = 'model-suscripcion bancaria'
DESCRIPTION = "Proyecto de modelo de suscripción bancaria para la materia de Despliegue de modelos"
URL = ""
EMAIL = "da.martinezm12@uniandes.edu.co"
AUTHOR = "darturomartinez"
